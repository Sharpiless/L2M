...
def test_relative_pose_vismmim(
    ...
    elif args.choose_model == 1:
        test_list = data_root_dir / 'test_list_2.txt'
    elif args.choose_model == 2:
        test_list = data_root_dir / 'test_list_3.txt'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--choose_model', type=int, default=0, choices=[0, 1, 2], help='0:Medical,1:RemoteSensing,2:RGB_NIR')
